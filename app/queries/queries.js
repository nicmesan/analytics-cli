...
queries.similarityFinalClassesInsert = 'INSERT INTO product_matches_final_classes (SELECT pms.originalKeywordId, ks.keywordValue, ks.clientId FROM product_matches_similarity pms INNER JOIN keywords ks ON pms.originalKeywordId = ks.id WHERE cast(pms.matched_products/pms.total_products as decimal(5,4)) > ? ORDER BY keywordValue DESC LIMIT 1);';
